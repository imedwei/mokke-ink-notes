...
internal class WhisperLib {
    companion object {
        ...
        external fun fullTranscribe(contextPtr: Long, numThreads: Int, audioData: FloatArray, vadModelPath: String? = null)
        ...
        external fun getTokenProbability(contextPtr: Long, segmentIndex: Int, tokenIndex: Int): Float
